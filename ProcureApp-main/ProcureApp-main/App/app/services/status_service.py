...
RFQ_TRANSITIONS = {
    ...
    'pending_delivery': {
        RFQStatus.RECEIVED.value: ['company', 'chief'],                  # Alias support
    },
    'offers_received': {
        RFQStatus.CLOSED.value: ['company', 'chief'],                    # Alias support
        RFQStatus.PENDING_FINAL_APPROVAL.value: ['company'],
    },
...
BID_TRANSITIONS = {
    ...
    BidStatus.SUBMITTED.value: {
        ...
        BidStatus.ACCEPTED.value: ['company', 'chief'],                             # Evaluation: Accept this bid
        BidStatus.REJECTED.value: ['company', 'chief'],                             # Evaluation: Reject this bid
    },
